		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
			{
				...
				http.onData = function(data:String)
				{
					...
					if (new_Ver.patch > old_Ver.patch && new_Ver.minor >= old_Ver.minor && new_Ver.major >= old_Ver.major || new_Ver.minor > old_Ver.minor
						&& new_Ver.major >= old_Ver.major || new_Ver.major > old_Ver.major)
						older = true;
